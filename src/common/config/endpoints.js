...
const endpoints = {
  ...
  getUserDataById(userId) {
    const endpoint = new URL(
      `${API_VERSION}/user/search?user_id=${userId}`,
      BASE_URL
    ).href;
  ...
  updateOrg(orgId) {
    const endpoint = new URL(`${API_VERSION}/organisations/${orgId}`, BASE_URL)
      .href;
  ...
  getOrgUsers(orgId) {
    const endpoint = new URL(
      `${API_VERSION}/organisations/${orgId}/users`,
      BASE_URL
    ).href;
  ...
  createCraft(userId) {
    const endpoint = new URL(`${API_VERSION}/user/${userId}/crafts`, BASE_URL)
      .href;
  ...
  getCraftData(userId, craftId) {
    const endpoint = new URL(
      `${API_VERSION}/user/${userId}/crafts/${craftId}`,
      BASE_URL
    ).href;
  ...
  getOrgCrafts(orgId) {
    const endpoint = new URL(
      `${API_VERSION}/organisations/${orgId}/crafts`,
      BASE_URL
    ).href;
  ...
  createResPerson(userId) {
    const endpoint = new URL(
      `${API_VERSION}/user/${userId}/responsiblepersons`,
      BASE_URL
    ).href;
  ...
  deleteResPerson(userId, responsiblepersonId) {
    ...
    logger.debug(
      `Calling delete responsible person details endpoint ${endpoint}`
    );
    return endpoint;
  },
  createPerson(userId) {
    const endpoint = new URL(`${API_VERSION}/user/${userId}/people`, BASE_URL)
      .href;
  ...
  getPersonData(userId, personId) {
    const endpoint = new URL(
      `${API_VERSION}/user/${userId}/people/${personId}`,
      BASE_URL
    ).href;
  ...
  getOrgPeople(orgId) {
    const endpoint = new URL(
      `${API_VERSION}/organisations/${orgId}/people`,
      BASE_URL
    ).href;
  ...
  createGar(userId) {
    const endpoint = new URL(`${API_VERSION}/user/${userId}/gar`, BASE_URL)
      .href;
  ...
  getGar(garId, isCbpId = false) {
    const endpoint = new URL(
      `${API_VERSION}/gar/${garId}?cbp_id=${String(isCbpId)}`,
      BASE_URL
    ).href;
  ...
  submitGARForCheckin(garId) {
    const endpoint = new URL(`${API_VERSION}/gar/${garId}/checkin`, BASE_URL)
      .href;
  ...
  getGarPeople(garId, amg_response_code_priority) {
    ...
    const endpoint = new URL(
      `${API_VERSION}/gar/${garId}/people?page=1&per_page=10000&${priority}`,
      BASE_URL
    ).href;
  ...
  updateGarPerson(garId) {
    const endpoint = new URL(`${API_VERSION}/gar/${garId}/people`, BASE_URL)
      .href;
