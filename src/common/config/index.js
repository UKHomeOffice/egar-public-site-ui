...
exports.NOTIFY_GAR_CANCEL_TEMPLATE_ID =
  process.env.NOTIFY_GAR_CANCEL_TEMPLATE_ID;
exports.NOTIFY_GAR_SUBMISSION_TEMPLATE_ID =
  process.env.NOTIFY_GAR_SUBMISSION_TEMPLATE_ID;
exports.NOTIFY_MFA_TEMPLATE_ID = process.env.NOTIFY_MFA_TEMPLATE_ID;
exports.NOTIFY_ACCOUNT_DELETE_TEMPLATE_ID =
  process.env.NOTIFY_ACCOUNT_DELETE_TEMPLATE_ID;
exports.NOTIFY_ORGANISATION_DELETE_TEMPLATE_ID =
  process.env.NOTIFY_ORGANISATION_DELETE_TEMPLATE_ID;

exports.NOTIFY_NOT_REGISTERED_TEMPLATE_ID =
  process.env.NOTIFY_NOT_REGISTERED_TEMPLATE_ID;
exports.NOTIFY_ONE_LOGIN_INVITE_TEMPLATE_ID =
  process.env.NOTIFY_ONE_LOGIN_INVITE_TEMPLATE_ID;

// Server settings
exports.SESSION_ENCODE_SECRET =
  process.env.SESSION_ENCODE_SECRET || 'thisShouldBeLongAndSecret';
exports.SESSION_PARSER_SECRET =
  process.env.SESSION_PARSER_SECRET || '3169n$*INDUKFIN*s47y4917$p';
...
// Misc settings
exports.CORRELATION_HEADER =
  process.env.CORRELATION_HEADER_NAME || 'x-request-id';
exports.CONNECTOR_URL = process.env.CONNECTOR_URL;
exports.CONTACT_EMAIL =
  process.env.CONTACT_URL || 'supportegar@homeoffice.gov.uk';
...
exports.USER_FIRST_NAME_CHARACTER_COUNT =
  process.env.USER_FIRST_NAME_CHARACTER_COUNT || 25;
exports.USER_GIVEN_NAME_CHARACTER_COUNT = 50;
exports.USER_SURNAME_CHARACTER_COUNT =
  process.env.USER_SURNAME_CHARACTER_COUNT || 25;
...
// Token settings
exports.MFA_TOKEN_LENGTH =
  parseInt(process.env.NOTIFY_MFA_TOKEN_LENGTH, 10) || 8;
exports.MFA_TOKEN_EXPIRY = parseInt(process.env.NOTIFY_MFA_TOKEN_TTL, 10) || 5;
exports.MFA_TOKEN_MAX_ATTEMPTS =
  parseInt(process.env.NOTIFY_MFA_TOKEN_MAX_ATTEMPTS, 10) || 5;
...
exports.CARRIER_SUPPORT_HUB_UK_NUMBER =
  process.env.CARRIER_SUPPORT_HUB_UK_NUMBER;
exports.CARRIER_SUPPORT_HUB_INTERNATIONAL_NUMBER =
  process.env.CARRIER_SUPPORT_HUB_INTERNATIONAL_NUMBER;
...
exports.ONE_LOGIN_POST_MIGRATION =
  process.env.ONE_LOGIN_POST_MIGRATION === 'true';
exports.ONE_LOGIN_SHOW_ONE_LOGIN =
  process.env.ONE_LOGIN_SHOW_ONE_LOGIN === 'true';
exports.ONE_LOGIN_ACCOUNT_URL = process.env.ONE_LOGIN_ACCOUNT_URL;
exports.IS_HTTPS_SERVER = process.env.BASE_URL
...
exports.NOTIFY_ADMIN_ABOUT_USER_EMAIL_CHANGE_TEMPLATE_ID =
  process.env.NOTIFY_ADMIN_ABOUT_USER_EMAIL_CHANGE_TEMPLATE_ID;
exports.NOTIFY_ONELOGIN_ACCOUNT_DELETE_TEMPLATE_ID =
  process.env.NOTIFY_ONELOGIN_ACCOUNT_DELETE_TEMPLATE_ID;
exports.USE_NEW_NATIONALITY_LIST_PROVIDER =
  process.env.USE_NEW_NATIONALITY_LIST_PROVIDER === 'true';
