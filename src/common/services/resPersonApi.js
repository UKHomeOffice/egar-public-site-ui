    ...
    return new Promise((resolve, reject) => {
      request.post(
        ...
        (error, _response, body) => {
          if (error) {
            logger.error(
              'Failed to call responsible person creation API endpoint'
            );
            reject(error);
            return;
          }
          logger.debug(
            'Successfully called responsible person creation endpoint'
          );
          resolve(body);
        }
      );
    ...
    return new Promise((resolve, reject) => {
      ...
      request.get(
        ...
        (error, _response, body) => {
          if (error) {
            logger.error(
              'Failed to call get responsible person details endpoint'
            );
            reject(error);
            return;
          }
          logger.debug(
            'Successfully called get responsible details API endpoint'
          );
          resolve(body);
        }
      );
    ...
    return new Promise((resolve, reject) => {
      request.put(
        ...
        (error, _response, body) => {
          ...
          logger.debug(
            'Successfully called update person details API endpoint'
          );
          resolve(body);
        }
      );
    ...
    return new Promise((resolve, reject) => {
      request.delete(
        ...
        (error, _response, body) => {
          ...
          logger.debug(
            'Successfully called delete responsible person endpoint'
          );
          resolve(body);
        }
      );
