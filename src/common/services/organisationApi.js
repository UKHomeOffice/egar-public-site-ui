      ...
      request.put(
        ...
        (error, response, body) => {
          ...
          if (response.statusCode >= 400) {
            logger.error(
              `Update organisation API returned error status: ${response.statusCode}`
            );
    ...
    return new Promise((resolve, reject) => {
      request.get(
        ...
        (error, _response, body) => {
          ...
          logger.debug(
            'Successfully called get organisation users API endpoint'
          );
          resolve(body);
        }
      );
    ...
    return new Promise((resolve, reject) => {
      request.get(
        ...
        (error, _response, body) => {
          if (error) {
            logger.error(
              'Failed to call get list organisation users API endpoint'
            );
            reject(error);
            return;
          }
          logger.debug(
            'Successfully called get list organisation users API endpoint'
          );
          resolve(body);
        }
      );
    ...
    return new Promise((resolve, reject) => {
      request.patch(
        ...
        (error, _response, body) => {
          ...
          logger.debug(
            'Successfully called edit organisation users API endpoint'
          );
          resolve(body);
        }
      );
    ...
    return new Promise((resolve, reject) => {
      request.get(
        ...
        (error, _response, body) => {
          if (error) {
            logger.error(
              'Failed to call get search organisation users API endpoint'
            );
            reject(error);
            return;
          }
          logger.debug(
            'Successfully called get search organisation users API endpoint'
          );
          resolve(body);
        }
      );
