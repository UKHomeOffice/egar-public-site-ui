...
module.exports = (req, res) => {
  ...
  logger.debug('In organisation / saved people add get controller');
  res.render('app/organisation/savedpeople/add/index', { cookie, genderchoice, persontype, documenttype });
};
