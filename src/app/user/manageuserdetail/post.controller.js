...
module.exports = (req, res) => {
  ...
  const firstNameChain = [
    ...
    new ValidationRule(validator.isValidStringLength, 'firstname', firstName, `Given name(s) must be ${MAX_STRING_LENGTH} characters or less`),
    ...
    new ValidationRule(validator.validFirstNameLength, 'firstname', firstName, `Please enter a given name(s) of at most ${USER_GIVEN_NAME_CHARACTER_COUNT} characters`),
  ];
  const lnameChain = [
