...
const indexPath = '/login';
const paths = {
  index: indexPath,
};

// Routing
router.get(paths.index, flagpole, csrfcheck, usercheck, getController);
router.post(paths.index, flagpole, parseForm, csrfcheck, usercheck, postController);
