...
module.exports = (req, res) => {
  ...
  validator.validateChains(validations.validations(req))
      ...
      personApi.update(
        ...
        .then((apiResponse) => {
          ...
          if (Object.prototype.hasOwnProperty.call(parsedResponse, 'message')) {
            res.render('app/user/savedpeople/edit/index', { cookie, genderchoice, persontype, documenttype, errors: [parsedResponse] });
            // API returned error
          } else {
            // Successful
    ...
    .catch((err) => {
      ...
      logger.error(err);
      res.render('app/user/savedpeople/edit/index', { cookie, persontype, genderchoice, documenttype, errors: err, req });
    });
};
