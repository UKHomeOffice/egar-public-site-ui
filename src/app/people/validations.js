...
module.exports.validations = (req, useValidation = 'DEFAULT') => {
  ...
  function passengerInfoValidation() {
    return [
      [
  ...
  function travelDocumentValidation() {
    let result = [
      [
  ...
  let peopleValidationRules = []

  logger.info(useValidation);


  if (useValidation === "PASSENGER") {
    peopleValidationRules = [
      ...passengerInfoValidation()
    ];
    
  } else if (useValidation === "TRAVEL") {
    peopleValidationRules = [
      ...travelDocumentValidation()
    ];
  } else {
    peopleValidationRules = [
      ...passengerInfoValidation(),
