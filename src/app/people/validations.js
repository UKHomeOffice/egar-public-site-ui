  ...
  if (docTypeOther === 'Other') {
    return [
      ...
      [
        ...
        new ValidationRule(validator.isAlphanumeric, 'travelDocumentNumber', req.body.travelDocumentNumber, `Travel document number must consistent only of Alphanumeric characters e.g. a-z, A-Z and 0-9. No special characters are allowed e.g. $ % !`),
      ],
      [
