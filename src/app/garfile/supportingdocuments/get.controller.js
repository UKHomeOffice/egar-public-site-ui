...
module.exports = (req, res) => {
  ...
  garApi.getSupportingDocs(cookie.getGarId())
    .then((apiResponse) => {
      ...
      const context = { cookie, supportingDoc };
      let error = null;
      ...
      logger.error(err);
      res.render('app/garfile/supportingdocuments/index', { cookie, errors: [{ message: 'There was a problem getting GAR supporting documents information' }] });
    });
};
