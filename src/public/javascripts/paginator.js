...
function initialisePagination(
  ...
  elements.previousButton = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__previous_button'
  );
  elements.nextButton = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__next_button'
  );
  elements.firstNumber = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__first_number'
  );
  elements.firstEllipses = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__first_ellipses'
  );
  elements.lastNumber = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__last_number'
  );
  elements.lastEllipses = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__last_ellipses'
  );
  elements.previousNumber = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__previous_number'
  );
  elements.previousNumberLink = document.querySelector(
    '.pagination__' +
      paginationName +
      '_paginator .pagination__previous_number .pagination__link'
  );
  elements.currentNumber = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__current_number'
  );
  elements.currentNumberLink = document.querySelector(
    '.pagination__' +
      paginationName +
      '_paginator .pagination__current_number .pagination__link'
  );
  elements.nextNumber = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__next_number'
  );
  elements.nextNumberLink = document.querySelector(
    '.pagination__' +
      paginationName +
      '_paginator .pagination__next_number .pagination__link'
  );
  ...
  if (maxPages <= 1) {
    hideElement(
      document.querySelector('.pagination__' + paginationName + '_paginator')
    );
  }
}
...
function goToPage(paginationName, page) {
  ...
  document
    .querySelectorAll(
      '.pagination__table_' + paginationName + ' .pagination-page'
    )
  ...
  paginationData.elements.previousNumberLink.textContent =
    paginationData.currentPage - 1;
  paginationData.elements.previousNumberLink.ariaLabel =
    'Page ' + paginationData.currentPage - 1;
  paginationData.elements.currentNumberLink.textContent =
    paginationData.currentPage;
  paginationData.elements.currentNumberLink.ariaLabel =
    'Page ' + paginationData.currentPage + ', current page';
  paginationData.elements.nextNumberLink.textContent =
    paginationData.currentPage + 1;
  paginationData.elements.nextNumberLink.ariaLabel =
    'Page ' + paginationData.currentPage + 1;
...
function goToNextPage(paginationName) {
  goToPage(
    paginationName,
    this.paginationState[paginationName].currentPage + 1
  );
}
