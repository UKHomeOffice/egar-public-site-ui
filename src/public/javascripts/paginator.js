...
function initialisePagination(paginationName, totalResults, maxPages, pageSize) {
  ...
  elements.previousNumberLink = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__previous_number .pagination__link'
  );
  ...
  elements.currentNumberLink = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__current_number .pagination__link'
  );
  ...
  elements.nextNumberLink = document.querySelector(
    '.pagination__' + paginationName + '_paginator .pagination__next_number .pagination__link'
  );
...
function goToPage(paginationName, page) {
  ...
  document
    .querySelectorAll('.pagination__table_' + paginationName + ' .pagination-page')
