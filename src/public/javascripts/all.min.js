(function (t, e) {
    ...
    e ||
      (function (t) {
        ...
        Object.defineProperty = function (i, r, s) {
          if (
            t &&
            (i === window || i === document || i === Element.prototype || i instanceof Element)
          )
            return t(i, r, s);
        ...
        Object.defineProperty(Function.prototype, 'bind', {
          value: function (t) {
            ...
            return (
              ...
              v.prototype &&
                ((s.prototype = v.prototype), (y.prototype = new s()), (s.prototype = null)),
              y
            );
          },
        });
                    ...
                    if (i.length)
                      for (n = 0; n < i.length; ++n)
                        if (c.test(i[n]))
                          throw (
                            (t = new SyntaxError(
                              'String "' + i[n] + '" contains an invalid character'
                            )),
                            (t.code = 5),
            ...
            (function () {
              ...
              if ('classList' in t && (t.classList.add('a', 'b'), !t.classList.contains('b'))) {
                ...
                t.classList.constructor.prototype.add = function () {
                  for (var t = arguments, n = arguments.length, o = 0; o < n; o++)
                    e.call(this, t[o]);
                };
              }
            })(),
      ...
      e ||
        (function () {
          ...
          (r.attachEvent('onpropertychange', function (t) {
            for (
              var e, n = t.propertyName, o = !s.hasOwnProperty(n), i = r[n], a = s[n], l = -1;
              (e = c[++l]);
                        ...
                        t._events[o] ||
                          ((t._events[o] = function (n) {
                            ...
                            for (
                              ...
                              s in r &&
                                ((o = r[s]),
                                e(i, o) !== -1 && 'function' == typeof o && o.call(t, n));
                          }),
                          (t._events[o].list = []),
  ...
  ((r.prototype.handleInputs = function (t, e) {
    ...
    function (t) {
      ...
      e ||
        (Element.prototype.matches =
          ...
          function (t) {
            for (
              var e = this, n = (e.document || e.ownerDocument).querySelectorAll(t), o = 0;
              n[o] && n[o] !== e;
    ...
    (c.prototype.getAssociatedLegendOrLabel = function (t) {
      ...
      return (
        document.querySelector("label[for='" + t.getAttribute('id') + "']") || t.closest('label')
      );
    }),
