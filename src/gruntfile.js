  ...
  const copy = {
    ...
    govuk: {
      files: [
        ...
        {
          expand: true,
          cwd: 'node_modules/govuk_frontend',
          src: '**',
          dest: 'govuk_modules/govuk_frontend/'
        },
        {
          expand: true,
    ...
    target: {
      files: {
        'public/stylesheets/application.min.css': [
          ...
          'public/stylesheets/govuk-frontend-2.1.0.min.css'
        ]
      }
    }
  }
  ...
  const concat = {
    ...
    dist: {
      src: [
        ...
        'public/javascripts/govuk-frontend-2.1.0.min.js'
      ],
