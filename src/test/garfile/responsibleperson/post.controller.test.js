...
describe('GAR Responsible Person Post Controller', () => {
  ...
  it('should render with validation messages if no FBO selection is made (1)', async () => {
  ...
  it('should render with validation messages if no FBO selection is made (2)', async () => {
    req.body.fixedBasedOperator = '';
    req.body.fixedBasedOperatorAnswer = '';
    cookie = new CookieModel(req);
    cookie.setGarResponsiblePerson(req.body);
    sinon.stub(garApi, 'patch');
