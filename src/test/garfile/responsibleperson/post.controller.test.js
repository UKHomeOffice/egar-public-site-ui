  ...
  it('should render with validation messages if FBO answer is blank', async () => {
    ...
    callController().then(() => {
      ...
      expect(res.render).to.have.been.calledWith('app/garfile/responsibleperson/index', {
        ...
        fixedBasedOperatorOptions,
        errors: [
          req.body.fixedBasedOperator !== 'Other' ? new ValidationRule(validator.notEmpty, 'fixedBasedOperator', fixedBasedOperator, `Select the role of the responsible person.`) : new ValidationRule(validator.notEmpty, 'fixedBasedOperatorAnswer', req.body.fixedBasedOperatorAnswer, `Enter your responsible person role.`),
        ],
      });
    });
  });
