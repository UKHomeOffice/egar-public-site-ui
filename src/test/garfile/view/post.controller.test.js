...
describe('GAR view post controller', () => {
  ...
  beforeEach(() => {
    ...
    getDurationBeforeDepartureStub = sinon.stub(
      garApi,
  ...
  describe('checkGARUser', () => {
    it('should return false if all undefined fields', () => {
      expect(controller.checkGARUser(undefined, undefined, undefined)).to.be
        .false;
    });
    ...
    it('should return false if user id no match and undefined organisation', () => {
      ...
      expect(controller.checkGARUser(parsedGar, undefined, 'USER-234')).to.be
        .false;
    });
    ...
    it('should return false if organisation id no match and undefined user', () => {
      ...
      expect(controller.checkGARUser(parsedGar, undefined, 'ORG-234')).to.be
        .false;
    });
    ...
    it('should return false if no match', () => {
      ...
      expect(controller.checkGARUser(parsedGar, 'USER-234', 'ORG-234')).to.be
        .false;
    });
    ...
    it('should return true if user ids match', () => {
      ...
      expect(controller.checkGARUser(parsedGar, 'USER-123', undefined)).to.be
        .true;
    });
    ...
    it('should return true if organisation ids match', () => {
      ...
      expect(controller.checkGARUser(parsedGar, 'USER-123', 'ORG-123')).to.be
        .true;
    });
  ...
  it('should redirect to home if the api does not find the GAR', () => {
    ...
    garApiGetPeopleStub.resolves(
      JSON.stringify({ message: 'GAR does not exist' })
    );
