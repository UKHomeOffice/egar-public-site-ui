...
describe('People Export Controller', () => {
  ...
  describe('api returns ok', () => {
    ...
    it('should display success message if set', () => {
      ...
      // Id,First Name,Middle Name,Last Name,Gender,DoB,Nationality,Doc Type,Doc Number,Doc Expiry,Doc Issuing State,Type\n
      callController()
        .then(() => {
          ...
          expect(res.write).to.have.been.calledWith('Id,First Name,Middle Name,Last Name,Gender,DoB,Nationality,Doc Type,Doc Number,Doc Expiry,Doc Issuing State,Type\n');
