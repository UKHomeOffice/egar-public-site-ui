...
describe('Decimal truncation tests', () => {
  it('should truncate long decimal to four places', () => {
    expect(utilFunctions.trimToDecimalPlaces('1.1234567', 4)).to.equal(
      '1.1234'
    );
  });
  ...
  it('should trim leading whitespace', () => {
    expect(utilFunctions.trimToDecimalPlaces(' 180.132', 4)).to.equal(
      '180.132'
    );
  });

  it('should trim trailing whitespace', () => {
    expect(utilFunctions.trimToDecimalPlaces('180.13244 ', 4)).to.equal(
      '180.1324'
    );
  });
});
