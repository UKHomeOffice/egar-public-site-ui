...
describe.skip('User Login Get Controller', () => {
  ...
  beforeEach(() => {
    ...
    sendOneLoginTokenRequestStub = sinon
      .stub(oneLoginApi, 'sendOneLoginTokenRequest')
      .resolves({
        access_token: 'mock_access_token',
        id_token: 'mock_id_token',
      });

    getUserInfoFromOneLogin = sinon
      .stub(oneLoginApi, 'getUserInfoFromOneLogin')
      .resolves({
        email_verified: true,
...
-----END PRIVATE KEY-----`;
  ...
  it('should update user details with OneLogin SID and redirect to home', async () => {
    ...
    updateUserData.returns(
      Promise.resolve({ userId: 'userid', redirect: '/home' })
    );
