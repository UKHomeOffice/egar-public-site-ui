...
describe.skip('User OneLogin Post Controller', () => {
  ...
  beforeEach(() => {
    ...
    getUserInviteTokenStub = sinon.stub(
      getUserInviteToken,
      'getUserInviteToken'
    );
  });
  ...
  describe('Cookie handling', () => {
    ...
    it('should set user cookies when creating user successfully', async () => {
      ...
      sinon
        .stub(CookieModel.prototype, 'setUserEmail')
        .callsFake(cookieSetSpy.setUserEmail);
      sinon
        .stub(CookieModel.prototype, 'setUserFirstName')
        .callsFake(cookieSetSpy.setUserFirstName);
      sinon
        .stub(CookieModel.prototype, 'setUserLastName')
        .callsFake(cookieSetSpy.setUserLastName);
      sinon
        .stub(CookieModel.prototype, 'setUserDbId')
        .callsFake(cookieSetSpy.setUserDbId);
      sinon
        .stub(CookieModel.prototype, 'setUserVerified')
        .callsFake(cookieSetSpy.setUserVerified);
      sinon
        .stub(CookieModel.prototype, 'setUserRole')
        .callsFake(cookieSetSpy.setUserRole);
      ...
      expect(cookieSetSpy.setUserEmail).to.have.been.calledWith(
        'john.doe@example.com'
      );
