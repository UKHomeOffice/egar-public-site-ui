...
describe('GarService', () => {
  beforeEach(() => {
    ...
    nock(BASE_URL)
      .get(`/gar/${garId}/people?page=1&per_page=10&priority=amg_checkin_response_code%3A0T%2Camg_checkin_response_code%3A0B%2Camg_checkin_response_code%3A0Z%2Camg_checkin_response_code%3A0A`)
      .reply(200, {
        "_meta": {
          "page": 1,
          "perPage": 100,
