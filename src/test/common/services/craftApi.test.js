...
describe('CraftService With Nock', () => {
  ...
  beforeEach(() => {
    ...
    nock(BASE_URL)
      .get(`/organisations/${orgId}/crafts?page=1&per_page=5`)
      .reply(200, {});

    nock(BASE_URL)
      .get(`/user/${userId}/crafts?page=2&per_page=5`)
      .reply(200, {});
  ...
  it('should throw an error when getting all crafts for an individual', () => {
    nock.cleanAll();
    nock(BASE_URL)
      .get(`/user/${userId}/crafts?page=1&per_page=5`)
