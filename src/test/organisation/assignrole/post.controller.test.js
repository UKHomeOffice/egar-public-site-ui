...
describe('Organisation Assign Role Post Controller', () => {
  ...
  beforeEach(() => {
    ...
    tokenServiceStub = sinon
      .stub(tokenService, 'generateHash')
      .returns('ExampleGeneratedHash');
      ...
      .then(() => {
        ...
        expect(res.render).to.have.been.calledOnceWithExactly(
          'app/organisation/assignrole/index',
          {
            ...
            errors: [
              {
                message: 'Could not send an invitation email, try again later.',
              },
            ],
          }
        );
